/**
 * Mục đích: Dữ liệu 140 kịch bản cho module Listening
 * Tham số đầu vào: không có
 * Tham số đầu ra: TOPIC_CATEGORIES, searchScenarios, getTotalScenarios, getRandomScenario
 * Khi nào sử dụng: TopicPicker component hiển thị danh sách kịch bản để user chọn
 *   - ConfigScreen → TopicPicker → dùng TOPIC_CATEGORIES để render
 *   - Search → searchScenarios() để filter realtime
 */

// ========================
// Types cho Topic Data
// ========================
...
/** Category lớn (IT, Daily, Personal) */
...
/**
 * Mục đích: Tìm kiếm kịch bản theo từ khóa
 * Tham số đầu vào: keyword (string) - từ khóa tìm kiếm
 * Tham số đầu ra: mảng kết quả chứa category, subCategory, scenario
 * Khi nào sử dụng: TopicPicker → user nhập search → gọi hàm này filter realtime
 */
...
/**
 * Mục đích: Đếm tổng số kịch bản
 * Tham số đầu vào: không có
 * Tham số đầu ra: number - tổng số scenarios
 * Khi nào sử dụng: Header hiển thị "140+ scenarios"
 */
...
/**
 * Mục đích: Lấy 1 kịch bản ngẫu nhiên
 * Tham số đầu vào: không có
 * Tham số đầu ra: object chứa category, subCategory, scenario
 * Khi nào sử dụng: Gợi ý random scenario khi user chưa biết chọn gì
 */
...
/**
 * Mục đích: Lấy danh sách scenarios theo category ID
 * Tham số đầu vào: categoryId (string)
 * Tham số đầu ra: TopicCategory | undefined
 * Khi nào sử dụng: TopicPicker → user chọn tab category → lấy data
 */
