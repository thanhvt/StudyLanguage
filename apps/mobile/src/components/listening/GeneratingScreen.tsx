...
import {View, Animated, Easing, TouchableOpacity, StyleSheet, ScrollView} from 'react-native';
  ...
  return (
    <View className="flex-1" style={{backgroundColor: colors.background}}>
      <ScrollView
        ...
        <View className="items-center px-8" style={{paddingTop: 60, paddingBottom: 24}}>
          {/* Thick Progress Ring */}
        ...
        {/* Spacer đẩy config card xuống dưới */}
